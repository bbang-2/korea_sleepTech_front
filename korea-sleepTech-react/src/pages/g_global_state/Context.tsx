...
//! === 리액트 '전역' 상태 관리 === //
// : 여러 컴포넌트에서 공통으로 사용하는 데이터를 한곳에서 관리
// - 프로젝트의 '전체 영역'에서 데이터를 공유 할 수 있는 방법
// EX) 로그인 상태, 테마 설정(다크/라이트 모드)
//      , 다국어 처리(언어 설정), 사용자 정보 등

//# 1. Context API
// : React에서 제공하는 '전역 상태관리 도구'
// - 컴포넌트 '트리' 전체에 걸쳐 데이터를 효율적으로 전달
// - 상위 컴포넌트 >> 하위 컴포넌트로 props 전달 없이 데이터 공유
