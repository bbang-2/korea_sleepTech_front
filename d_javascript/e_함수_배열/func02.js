...
log(); // undifined: 인자를 전달하지 않은 파라미터 값은 undifined

//? cf) undifined: 변수를 선언하고 초기화 이전의 타입
...
console.log(introtuce('이도경', 30)); // undifined


// cf) return이 없는 함수는 실행 시 undifined를 반환
//      >> 일반적으로 즉시 콘솔 출력 시 사용
