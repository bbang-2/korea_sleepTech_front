...
// +) async 함수 내부에서 await 키워드를 사용하여 Promsise의 결과를 기다림
...
// - 하나의 async 함수 내에서 여러 개의 await 사용
...
async function fetchCustomerData() {
  try {
    ...
    // .json()메서드
    // : json 데이터를 parse(분석)하여 JS객체로 변환
...
// 2) status
// : 응답의 HTTP 상태 코드를 반환 (예. 200, 404, 500 등)

// 3) statusText
// : 응답의 HTTP 상태 코드에 대한 텍스트 메세지 반환 (ex. "OK", "NOT FOUND", "SEVER ERROR" 등)
