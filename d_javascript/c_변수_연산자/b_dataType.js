...
// +) 템플릿 문자열: 문자열 내에 변수나 표현식을 사용 할 수 있는 문자열
//    >> 백틱(``) 사용
...
// 4-2) undifined: 정의되지 않다.
//      >> 변수가 선언되었으나, 어작 어떠한 값도 할당되지 않을 때의 기본값
...
let notANumbr = '이건 숫자로 변환이 가능?';
console.log(Number(notANumbr));
// NaN: Not a Number
// - 숫자로 변환 할 수 없는 값 변환을 사도한 경우

// 3)논리형 변환 (boolean())

// false: flase, 0, '', null, undifined, Nan
