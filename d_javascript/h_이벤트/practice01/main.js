...
function addTodo() {
  ...
  if (todoInput.value !== '') {
    ...
    // - 생성된 태그가 곧바로 웹 문서에 할당되지x
    // - 보여질 위치의 부모 요소에 삽입
    let newItem = document.createElement('li');

    // 새로운 li의 내용 값 = input창의 입력 값
    ...
    //? input 등과 같이 상호작용 된 데이터는 사용하고나면 해당 데이터 초디화
    todoInput.value = '';
  }
}
...
// +) Enter키 키보드 클릭으로 할 일 등록
//    : Enter키 입력 시 (todoInput 요소 내)
...
// - currentTarget: 이벤트 첨부된 요소 (todoList)
