...
// 1) 쿠키 생성
// : document.cookie 속성
// - 웹 부라우저에 쿠키를 생성하고 관리 (쿠키 설정, 읽기, 수정, 삭제)
...
// cf) 경로: 해당 웹 페이지에서 쿠키값에 접근 할 수 있는 경로를 지정
...
//      ex) "naver.com/news", "google.com/email"
...
// 1m === 60s
// 1s === 1000ms
// date.setTime(date.getTime() + (24 * 1 * 60 * 60 * 1000)); // 24시간(1일)
