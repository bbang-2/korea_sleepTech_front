{
    ...
    var TaskLogger_1 = /** @class */ (function () {
        ...
        TaskLogger.prototype.addTask = function (description) {
            ...
            this.renderTasks(); // 할 일 목록을 다시 화면에 재랜더링
            return newTask;
        };
        TaskLogger.prototype.deleteTask = function (taskId) {
            this.tasks = this.tasks.filter(function (task) { task.id !== taskId; });
            this.renderTasks();
        };
    ...
    var init = function () {
        ...
        window.addEventListener('click', function (e) {
            ...
            if (e.target === taskModal) {
                // 모달창 바깥 영역 클릭 시 모달 창 숨김
                if (taskModal) {
                    taskModal.style.display = 'none';
                }
            }
        });
        var handelAddTask = function () {
        ...
        addTaskButton === null || addTaskButton === void 0 ? void 0 : addTaskButton.addEventListener('cliick', handelAddTask);
