...
console.log(stringReturn('윤', '영서')); // 윤영서

//& null & undifined
// null: 아무것도 없음, 데이터가 잘못된 경우
// undifined: 변수 생성은 했지만, 안에 값이 없을 경우
...
// - 사전에 오류 타입 계산을 사용 할 수x (ts를 js처럼 사용)
...
function printMessage (parameter: string): void {
  console.log(parameter);
}