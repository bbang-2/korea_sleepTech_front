...
// greet(p1); - Person타입 속성 구조와 일치하지 않아 Person으로 취급되지 않음
...
// userProfile.adress.city = 'Daejeon'; // 읽기전용 속성이므로 'city'에 할당 할 수 없습니다.
userProfile.adress.zipCode = '중앙대로';

//# +) 객체의 인덱스 서명(signatuer, 시그니처)
...
let userData: UserDataType = {
  ...
  // 필요한 형식은 이 인덱스 시그니처에서 가져옵니다. - 해당 인덱스 서명
}

userData.email = 'devgiants75';
// userData.adress = { city: 'Busan'};